...
func (x *UsersResponse) GetId() uint64 {
	if x != nil {
		return x.Id
	}
	return 0
...
var file_proto_users_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x06, 0x64, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x22, 0x1e, 0x0a, 0x0c, 0x55,
	...
	0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x02, 0x69, 0x64, 0x32, 0x42, 0x0a, 0x0c,
	0x55, 0x73, 0x65, 0x72, 0x73, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x32, 0x0a, 0x04,
	0x53, 0x61, 0x76, 0x65, 0x12, 0x14, 0x2e, 0x64, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x2e, 0x55, 0x73,
	0x65, 0x72, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x14, 0x2e, 0x64, 0x6f, 0x6d,
	0x61, 0x69, 0x6e, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
...
var file_proto_users_proto_goTypes = []any{
	(*UsersRequest)(nil),  // 0: domain.UsersRequest
	(*UsersResponse)(nil), // 1: domain.UsersResponse
}
var file_proto_users_proto_depIdxs = []int32{
	0, // 0: domain.UsersService.Save:input_type -> domain.UsersRequest
	0, // 1: domain.UsersService.Save:output_type -> domain.UsersRequest
