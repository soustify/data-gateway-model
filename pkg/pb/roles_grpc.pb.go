...
type RoleServiceClient interface {
	...
	FindAll(ctx context.Context, in *RoleListRequest, opts ...grpc.CallOption) (*RoleListResponse, error)
}
...
func (c *roleServiceClient) FindAll(ctx context.Context, in *RoleListRequest, opts ...grpc.CallOption) (*RoleListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type RoleServiceServer interface {
	...
	FindAll(context.Context, *RoleListRequest) (*RoleListResponse, error)
...
func (UnimplementedRoleServiceServer) FindAll(context.Context, *RoleListRequest) (*RoleListResponse, error) {
...
func _RoleService_FindAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RoleServiceServer).FindAll(ctx, req.(*RoleListRequest))
	}
	return interceptor(ctx, in, info, handler)
}
