...
type ServiceCostServiceClient interface {
	Create(ctx context.Context, in *ServiceCost, opts ...grpc.CallOption) (*ServiceCostResponse, error)
	Update(ctx context.Context, in *ServiceCost, opts ...grpc.CallOption) (*ServiceCostResponse, error)
	FindAll(ctx context.Context, in *ServiceCostListRequest, opts ...grpc.CallOption) (*ServiceCostListResponse, error)
}
...
func (c *serviceCostServiceClient) Create(ctx context.Context, in *ServiceCost, opts ...grpc.CallOption) (*ServiceCostResponse, error) {
...
func (c *serviceCostServiceClient) Update(ctx context.Context, in *ServiceCost, opts ...grpc.CallOption) (*ServiceCostResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ServiceCostResponse)
...
func (c *serviceCostServiceClient) FindAll(ctx context.Context, in *ServiceCostListRequest, opts ...grpc.CallOption) (*ServiceCostListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type ServiceCostServiceServer interface {
	Create(context.Context, *ServiceCost) (*ServiceCostResponse, error)
	Update(context.Context, *ServiceCost) (*ServiceCostResponse, error)
	FindAll(context.Context, *ServiceCostListRequest) (*ServiceCostListResponse, error)
...
func (UnimplementedServiceCostServiceServer) Create(context.Context, *ServiceCost) (*ServiceCostResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Create not implemented")
}
func (UnimplementedServiceCostServiceServer) Update(context.Context, *ServiceCost) (*ServiceCostResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Update not implemented")
}
func (UnimplementedServiceCostServiceServer) FindAll(context.Context, *ServiceCostListRequest) (*ServiceCostListResponse, error) {
...
func _ServiceCostService_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServiceCostServiceServer).Create(ctx, req.(*ServiceCost))
	}
...
func _ServiceCostService_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServiceCostServiceServer).Update(ctx, req.(*ServiceCost))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ServiceCostService_FindAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServiceCostServiceServer).FindAll(ctx, req.(*ServiceCostListRequest))
	}
	return interceptor(ctx, in, info, handler)
}
